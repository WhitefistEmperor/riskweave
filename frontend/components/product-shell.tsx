...
export function ProductShell({ children }: { children: ReactNode }) {
  ...
  return (
    ...
    >
      ...
      <Sidebar>
        <SidebarHeader className="product-brand">
        ...
        <SidebarContent>
          <nav aria-label="Main navigation" className="product-navigation">
            ...
            <Link href="/investigations" aria-current="page">
        ...
        <SidebarFooter className="product-footer">
          <ShieldCheck size={19} />
          <p>
      ...
      <SidebarInset className="min-w-0">
        <header className="product-topbar">
          <div>
            <SidebarTrigger />
            <span>Network risk operations</span>
          </div>
